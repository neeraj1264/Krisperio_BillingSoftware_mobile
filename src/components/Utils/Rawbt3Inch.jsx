...
export default function Rawbt3Inch({
 ...
 const handleRawBTPrint = () => {
  ...
  const invoiceText = `
\x1B\x61\x01\x1B\x21\x30Krisperio\x1B\x21\x00

\x1B\x61\x01\x1D\x11\x10Ambala Hisar Road, Malakpur\x1D\x11\x00
\x1B\x61\x01\x1D\x11\x1074049-60488\x1D\x11\x00
